          ...
          <van-col span="12">
            ...
            >
              <van-image
                ...
                :src="uerInfo.photo"
              />
              <span class="mobile">{{ uerInfo.name }}</span>
            </van-row>
          </van-col>
        ...
        <van-row>
          <van-grid :border="false" class="grid">
            <van-grid-item text="头条">
              <template #icon>{{ uerInfo.art_count }}</template>
            </van-grid-item>
            <van-grid-item text="粉丝">
              <template #icon>{{ uerInfo.fans_count }}</template>
            </van-grid-item>
            <van-grid-item text="关注">
              <template #icon>{{ uerInfo.follow_count }}</template>
            </van-grid-item>
            <van-grid-item text="获赞">
              <template #icon>{{ uerInfo.like_count }}</template>
            </van-grid-item>
          </van-grid>
        </van-row>
      </div>
